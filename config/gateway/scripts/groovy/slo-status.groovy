...
// cookie that the browser sends to this app host (cookie domain is jrsz.org).
...
amReq.setUri('https://am.jrsz.org:8443/am/json/realms/root/realms/alpha/sessions?_action=getSessionInfo')
