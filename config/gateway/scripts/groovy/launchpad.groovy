...
<body>
  <main>
    ...
    <span class="eyebrow">jrsz.org lab</span>
    <h1>Launchpad</h1>
    ...
    <div class="grid">
      <div class="card">
        <h3>app1</h3>
        <p class="meta">https://app1.jrsz.org/</p>
        <p>Session-protected static demo backend.</p>
        <a class="button" href="https://app1.jrsz.org/">Launch app1</a>
      </div>
      <div class="card">
        <h3>app2</h3>
        <p class="meta">https://app2.jrsz.org/</p>
        <p>Session-protected static demo backend.</p>
        <a class="button" href="https://app2.jrsz.org/">Launch app2</a>
      </div>
      <div class="card">
        <h3>app3</h3>
        <p class="meta">https://app3.jrsz.org/</p>
        <p>Session-protected static demo backend.</p>
        <a class="button" href="https://app3.jrsz.org/">Launch app3</a>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card">
        <h3>app4</h3>
        <p class="meta">https://app4.jrsz.org/ &middot; client demo-pkce-app</p>
        <p>OIDC discovery, PKCE login, token + claim inspection on the callback page.</p>
        <a class="button" href="https://app4.jrsz.org/">Open app4</a>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card">
        <h3>app5</h3>
        <p class="meta">https://app5.jrsz.org/ &middot; client sdkPublicClient</p>
        <p>Modal Login Widget flow with OAuth redirect to <code>/callback.html</code> and userinfo display after sign-in.</p>
        <a class="button" href="https://app5.jrsz.org/">Open app5</a>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card">
        <h3>app8</h3>
        <p class="meta">https://app8.jrsz.org/ &middot; realm /scriptlab &middot; client scriptlab-rp</p>
        ...
        <a class="button" href="https://app8.jrsz.org/">Open app8</a>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card">
        ...
        <a class="button" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=SocialLogin#login/">Open OIDC external IDP login</a>
      </div>
    </div>
<p>&nbsp;</p>
    <hr>
    ...
    <div class="grid">
      <div class="card">
        ...
        <a class="button" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=SamlLogin#login/">Open external SAML IDP login</a>
      </div>
    </div>
<p>&nbsp;</p>
    <hr>
    ...
    <div class="grid">
      <div class="card">
        ...
        <a class="button" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=MFA#login/">Open MFA tree</a>
      </div>
      <div class="card">
        <h3>TOTP</h3>
        ...
        <a class="button" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=TOTP#login/">Open TOTP tree</a>
      </div>
      <div class="card">
        <h3>Passkeys</h3>
        ...
        <a class="button outline" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=Passkeys#login/">Open Passkeys tree</a>
      </div>
      <div class="card">
        <h3>Passwordless</h3>
        ...
        <a class="button outline" href="https://am.jrsz.org:8443/am/XUI/?realm=/alpha&amp;authIndexType=service&amp;authIndexValue=Passwordless#login/">Open Passwordless tree</a>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card">
        ...
        <p class="meta">https://app6.jrsz.org/ &middot; realm /timeout-test</p>
        ...
        <a class="button" href="https://app6.jrsz.org/">Open test console</a>
      </div>
    </div>
