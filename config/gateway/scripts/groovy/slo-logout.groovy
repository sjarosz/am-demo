...
// token, then expire the iPlanetDirectoryPro cookie across the jrsz.org domain.
...
def CLEAR_COOKIE = 'iPlanetDirectoryPro=; Domain=jrsz.org; Path=/; Max-Age=0; HttpOnly'
...
amReq.setUri('https://am.jrsz.org:8443/am/json/realms/root/realms/alpha/sessions?_action=logout')
